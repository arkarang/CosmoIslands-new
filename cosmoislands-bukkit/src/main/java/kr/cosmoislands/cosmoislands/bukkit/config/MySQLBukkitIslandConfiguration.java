...
public class MySQLBukkitIslandConfiguration extends AbstractMySQLIslandConfiguration {

    public MySQLBukkitIslandConfiguration(MySQLPropertyDataModel model) {
        super(model);
    }
